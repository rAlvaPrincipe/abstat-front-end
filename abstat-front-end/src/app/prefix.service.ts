...
export class PrefixService {
  ...
  readonly prefixes = {
    ...
    'http://www.loa-cnr.it/ontologies/DUL.owl#': 'ldul',
    ...
    'http://www.opengis.net/ont/gml#': 'gmlo',
  ...
  getExtendedURI(input: string): string {
    ...
    const localname =  input.replace(prefix + ':', '');
    ...
    if (!namespace || ( namespace === 'http://www.w3.org/2011/http#' && localname.startsWith('\/\/')) ) {
      namespace = 'http:';
    }
